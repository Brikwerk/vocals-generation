import os
import argparse
from solver_encoder import ConditionedSolver
...
def main(config):
    ...
    # Data loader.
    vcc_loader = get_loader_combined(config.data_dir, config.batch_size, config.len_crop)
    
    solver = ConditionedSolver(vcc_loader, config)
